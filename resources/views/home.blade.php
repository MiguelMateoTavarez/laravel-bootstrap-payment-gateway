            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('pay') }}" method="POST" id="paymentform">
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                ...
                                <div class="form-group" id="toggler">
                                    <div class="btn-group brn-group-toggle" data-toggle="buttons">
                        ...
                        <div class="text-center mt-3S">
                            <button class="btn btn-primary btn-lg" type="submit" id="payButton">Pay</button>
                        </div>
                    </form>
                </div>
            </div>
